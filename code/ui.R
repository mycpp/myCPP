...
shinyUI(fluidPage(theme = "bootstrap.css",
                  ...
                  fluidRow(column(12, align ="center",
                                  h4("Click", HTML('<a href="https://mycpp.gitbooks.io/tool/content/user_guide.html" onclick="ga(\'send\', \'event\', \'click\', \'View the Wiki\', \'Wiki\', 1)">here</a>'), "for a guide of how to use this tool")
                  )),
